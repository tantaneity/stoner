...
const uk: Translations = {
  ...
  pinLock: "PIN-блокування",
  pinLockDesc: "Вимагати PIN для відкриття",
  ...
  autoLock1m: "Через 1 хвилину",
  autoLock5m: "Через 5 хвилин",
  autoLock15m: "Через 15 хвилин",
  appTitle: "Назва у панелі задач",
  appTitlePlaceholder: "напр. Календар",
  appTitleHint: "Відображається в панелі задач та Alt+Tab",
